...
Requires: libLLVM-15-rust-1_67_0-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-15-rust-1_67_0-stable
Summary: Library for libLLVM-15-rust-1.67.0-stable.so

%description -n libLLVM-15-rust-1_67_0-stable
Library for libLLVM-15-rust-1.67.0-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-15-rust-1.67.0-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-15-rust-1_67_0-stable
%{_prefix}/lib/libLLVM-15-rust-1.67.0-stable.so
