...
Requires: libLLVM-18-rust-1_81_0-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-18-rust-1_81_0-stable
Summary: Library for libLLVM-18-rust-1.81.0-stable.so

%description -n libLLVM-18-rust-1_81_0-stable
Library for libLLVM-18-rust-1.81.0-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-18-rust-1.81.0-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-18-rust-1_81_0-stable
%{_prefix}/lib/libLLVM-18-rust-1.81.0-stable.so
