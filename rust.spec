...
Requires: libLLVM-16-rust-1_71_0-stable = %{epoch}:%{version}-%{release}
...
mv %{buildroot}%{_prefix}/src/etc/bash_completion.d/* %{buildroot}%{_datadir}/bash-completion/completions/
...
%package -n libLLVM-16-rust-1_71_0-stable
Summary: Library for libLLVM-16-rust-1.71.0-stable.so

%description -n libLLVM-16-rust-1_71_0-stable
Library for libLLVM-16-rust-1.71.0-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-16-rust-1.71.0-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-16-rust-1_71_0-stable
%{_prefix}/lib/libLLVM-16-rust-1.71.0-stable.so
