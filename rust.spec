...
Requires: libLLVM-22-rust-1_98_1-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-22-rust-1_98_1-stable
Summary: Library for libLLVM-22-rust-1.98.1-stable.so

%description -n libLLVM-22-rust-1_98_1-stable
Library for libLLVM-22-rust-1.98.1-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-22-rust-1.98.1-stable.so
%{_sysconfdir}/*
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
...
%files -n libLLVM-22-rust-1_98_1-stable
%{_prefix}/lib/libLLVM-22-rust-1.98.1-stable.so
