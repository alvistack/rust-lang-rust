...
Requires: libLLVM-20-rust-1_90_0-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-20-rust-1_90_0-stable
Summary: Library for libLLVM-20-rust-1.90.0-stable.so

%description -n libLLVM-20-rust-1_90_0-stable
Library for libLLVM-20-rust-1.90.0-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-20-rust-1.90.0-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-20-rust-1_90_0-stable
%{_prefix}/lib/libLLVM-20-rust-1.90.0-stable.so
