...
Requires: libLLVM-18-rust-1_80_1-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-18-rust-1_80_1-stable
Summary: Library for libLLVM-18-rust-1.80.1-stable.so

%description -n libLLVM-18-rust-1_80_1-stable
Library for libLLVM-18-rust-1.80.1-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-18-rust-1.80.1-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-18-rust-1_80_1-stable
%{_prefix}/lib/libLLVM-18-rust-1.80.1-stable.so
