...
Requires: libLLVM-14-rust-1_62_1-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-14-rust-1_62_1-stable
Summary: Library for libLLVM-14-rust-1.62.1-stable.so

%description -n libLLVM-14-rust-1_62_1-stable
Library for libLLVM-14-rust-1.62.1-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-14-rust-1.62.1-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-14-rust-1_62_1-stable
%{_prefix}/lib/libLLVM-14-rust-1.62.1-stable.so
