...
Requires: libLLVM-19-rust-1_85_1-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-19-rust-1_85_1-stable
Summary: Library for libLLVM-19-rust-1.85.1-stable.so

%description -n libLLVM-19-rust-1_85_1-stable
Library for libLLVM-19-rust-1.85.1-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-19-rust-1.85.1-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-19-rust-1_85_1-stable
%{_prefix}/lib/libLLVM-19-rust-1.85.1-stable.so
