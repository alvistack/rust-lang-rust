...
Requires: libLLVM-17-rust-1_73_0-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-17-rust-1_73_0-stable
Summary: Library for libLLVM-17-rust-1.73.0-stable.so

%description -n libLLVM-17-rust-1_73_0-stable
Library for libLLVM-17-rust-1.73.0-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-17-rust-1.73.0-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-17-rust-1_73_0-stable
%{_prefix}/lib/libLLVM-17-rust-1.73.0-stable.so
