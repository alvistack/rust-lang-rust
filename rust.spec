...
Requires: libLLVM-21-rust-1_92_0-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-21-rust-1_92_0-stable
Summary: Library for libLLVM-21-rust-1.92.0-stable.so

%description -n libLLVM-21-rust-1_92_0-stable
Library for libLLVM-21-rust-1.92.0-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-21-rust-1.92.0-stable.so
%{_sysconfdir}/*
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
...
%files -n libLLVM-21-rust-1_92_0-stable
%{_prefix}/lib/libLLVM-21-rust-1.92.0-stable.so
