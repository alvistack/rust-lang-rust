...
Requires: libLLVM-15-rust-1_68_2-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-15-rust-1_68_2-stable
Summary: Library for libLLVM-15-rust-1.68.2-stable.so

%description -n libLLVM-15-rust-1_68_2-stable
Library for libLLVM-15-rust-1.68.2-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-15-rust-1.68.2-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-15-rust-1_68_2-stable
%{_prefix}/lib/libLLVM-15-rust-1.68.2-stable.so
