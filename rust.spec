...
Requires: libLLVM-14-rust-1_61_0-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-14-rust-1_61_0-stable
Summary: Library for libLLVM-14-rust-1.61.0-stable.so

%description -n libLLVM-14-rust-1_61_0-stable
Library for libLLVM-14-rust-1.61.0-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-14-rust-1.61.0-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-14-rust-1_61_0-stable
%{_prefix}/lib/libLLVM-14-rust-1.61.0-stable.so
