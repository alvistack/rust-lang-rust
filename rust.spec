...
Requires: libLLVM-17-rust-1_74_1-stable = %{epoch}:%{version}-%{release}
...
%package -n libLLVM-17-rust-1_74_1-stable
Summary: Library for libLLVM-17-rust-1.74.1-stable.so

%description -n libLLVM-17-rust-1_74_1-stable
Library for libLLVM-17-rust-1.74.1-stable.so.
...
%exclude %{_prefix}/lib/libLLVM-17-rust-1.74.1-stable.so
%{_bindir}/rust-gdb
%{_bindir}/rust-gdbgui
%{_bindir}/rust-lldb
%{_bindir}/rustc
...
%files -n libLLVM-17-rust-1_74_1-stable
%{_prefix}/lib/libLLVM-17-rust-1.74.1-stable.so
